...
| Prompt sinh code mẫu | 5 | Setup layer, Register API, Login API, Email OTP infrastructure và Verify Email |
| Prompt debug lỗi | 2 | Kiểm tra package/test chưa phù hợp và build bị khóa process API |
| Prompt viết test case | 3 | Test AuthController, JwtTokenService và verify/resend endpoints |
